...
static void Home_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_SCREEN_LOADED:
    {
        ...
        ui_animation(guider_ui.Home_img_fan, 1000, 0, lv_img_get_angle(guider_ui.Home_img_fan), 360*10, &lv_anim_path_linear, -1, 0, 0, 0, guider_anim_exec_set_angle, NULL, NULL, NULL);
        home_task = lv_timer_create(home_timer_cb, 80, &guider_ui);
        guider_anim_pause(guider_ui.Home_img_fan, guider_anim_exec_set_angle);
        guider_anim_pause(guider_ui.Home_img_snow, guider_anim_exec_set_y);
        guider_anim_pause(guider_ui.Home_img_snow_1, guider_anim_exec_set_y);
        guider_anim_pause(guider_ui.Home_img_snow_2, guider_anim_exec_set_y);
...
static void Home_sw_air_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        case (true):
        {
            ...
            guider_anim_resume(guider_ui.Home_img_fan, guider_anim_exec_set_angle);
            guider_anim_resume(guider_ui.Home_img_snow, guider_anim_exec_set_y);
            guider_anim_resume(guider_ui.Home_img_snow_1, guider_anim_exec_set_y);
            guider_anim_resume(guider_ui.Home_img_snow_2, guider_anim_exec_set_y);
            ui_animation(guider_ui.Home_img_snow, 1000, 0, lv_obj_get_y(guider_ui.Home_img_snow), 160, &lv_anim_path_linear, -1, 0, 1000, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow, lv_color_hex(0xc7f0cf), LV_PART_MAIN);
            ui_animation(guider_ui.Home_img_snow_2, 800, 0, lv_obj_get_y(guider_ui.Home_img_snow_2), 170, &lv_anim_path_linear, -1, 0, 800, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow_2, lv_color_hex(0x8deca0), LV_PART_MAIN);
            ui_animation(guider_ui.Home_img_snow_1, 2000, 0, lv_obj_get_y(guider_ui.Home_img_snow_1), 182, &lv_anim_path_linear, -1, 0, 2000, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
...
static void Electricity_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_SCREEN_LOADED:
    {
        ui_animation(guider_ui.Electricity_cont_1, 1000, 0, lv_obj_get_y(guider_ui.Electricity_cont_1), 60, &lv_anim_path_bounce, 0, 0, 0, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_5, 1000, 800, lv_obj_get_y(guider_ui.Electricity_cont_5), 130, &lv_anim_path_bounce, 0, 0, 0, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_4, 1500, 1000, lv_obj_get_y(guider_ui.Electricity_cont_4), 220, &lv_anim_path_bounce, 0, 0, 0, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_3, 1200, 400, lv_obj_get_y(guider_ui.Electricity_cont_3), 110, &lv_anim_path_bounce, 0, 0, 0, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_2, 1000, 1000, lv_obj_get_y(guider_ui.Electricity_cont_2), 400, &lv_anim_path_bounce, 0, 0, 0, 0, guider_anim_exec_set_y, NULL, NULL, NULL);
        break;
    }
    default:
        break;

...
typedef struct
{
	...
	lv_obj_t *Home_arc_2;
	lv_obj_t *Home_gpu_percent_label;
	lv_obj_t *Home_gpu_percent;
	lv_obj_t *Home_gpu_monitor_title;
	lv_obj_t *Home_gpu_frequency_label;
	lv_obj_t *Home_gram_label;
	lv_obj_t *Home_gram_slider;
	lv_obj_t *Home_gpu_temp_label;
	lv_obj_t *Home_gpu_frequency_data;
	lv_obj_t *Home_gpu_frequency_unit;
	lv_obj_t *Home_gpu_temp_unit;
	lv_obj_t *Home_gpu_temp_data;
	lv_obj_t *Home_gram_unit;
	lv_obj_t *Home_gram_data;

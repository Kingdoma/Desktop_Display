...
void setup_scr_Home(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->Home_cpu_usage, 0, 26);
    ...
    lv_obj_set_pos(ui->Home_cpu_fequency_label, 21, 167);
    ...
    lv_obj_set_pos(ui->Home_cpu_fequency_data, 70, 168);
    ...
    lv_label_set_text(ui->Home_cpu_fequency_unit, "G");
    lv_label_set_long_mode(ui->Home_cpu_fequency_unit, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_cpu_fequency_unit, 108, 168);
    ...
    ui->Home_cont_2 = lv_obj_create(ui->Home_cont_gpu_monitor);
    lv_obj_set_pos(ui->Home_cont_2, 0, 26);
    lv_obj_set_size(ui->Home_cont_2, 143, 148);
    ...
    lv_obj_set_style_border_width(ui->Home_cont_2, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->Home_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->Home_cont_2, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->Home_cont_2, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Home_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_arc_2 = lv_arc_create(ui->Home_cont_2);
    ...
    ui->Home_label_20 = lv_label_create(ui->Home_cont_2);
    lv_label_set_text(ui->Home_label_20, "%");
    lv_label_set_long_mode(ui->Home_label_20, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_20, 79, 51);
    lv_obj_set_size(ui->Home_label_20, 31, 39);
    ...
    lv_obj_set_style_radius(ui->Home_label_20, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_20, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_20, &lv_font_montserratMedium_35, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_20, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->Home_label_20, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_19 = lv_label_create(ui->Home_cont_2);
    lv_label_set_text(ui->Home_label_19, "50");
    lv_label_set_long_mode(ui->Home_label_19, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_19, 16, 51);
    lv_obj_set_size(ui->Home_label_19, 59, 39);
    ...
    lv_obj_set_style_radius(ui->Home_label_19, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_19, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_19, &lv_font_montserratMedium_35, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Home_label_19, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Home_label_19, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Home_label_19, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_19, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_19, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_19, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes Home_label_18
    ui->Home_label_18 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_18, "GPU Monitor");
    lv_label_set_long_mode(ui->Home_label_18, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_18, 0, 0);
    lv_obj_set_size(ui->Home_label_18, 146, 26);

    //Write style for Home_label_18, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Home_label_18, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_18, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_18, &lv_font_montserratMedium_15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Home_label_18, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_18, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_18, 59, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Home_label_18, lv_color_hex(0x1e1e1e), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Home_label_18, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_18, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Home_label_18, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Home_label_18, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Home_label_17
    ui->Home_label_17 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_17, "Freq:");
    lv_label_set_long_mode(ui->Home_label_17, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_17, 21, 167);
    lv_obj_set_size(ui->Home_label_17, 46, 23);
    ...
    lv_obj_set_style_text_color(ui->Home_label_17, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_17, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_17, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_17, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_17, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_17, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_16 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_16, "GRAM:");
    lv_label_set_long_mode(ui->Home_label_16, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_16, 1, 224);
    lv_obj_set_size(ui->Home_label_16, 66, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_16, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_16, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_16, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_16, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_16, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_16, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_16, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes Home_slider_1
    ui->Home_slider_1 = lv_slider_create(ui->Home_cont_gpu_monitor);
    lv_slider_set_range(ui->Home_slider_1, 0, 100);
    lv_slider_set_mode(ui->Home_slider_1, LV_SLIDER_MODE_NORMAL);
    lv_slider_set_value(ui->Home_slider_1, 90, LV_ANIM_OFF);
    lv_obj_set_pos(ui->Home_slider_1, 9, 250);
    lv_obj_set_size(ui->Home_slider_1, 124, 17);

    //Write style for Home_slider_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Home_slider_1, 57, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Home_slider_1, lv_color_hex(0xb5b5b5), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Home_slider_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Home_slider_1, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_outline_width(ui->Home_slider_1, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->Home_slider_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui->Home_slider_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Home_slider_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for Home_slider_1, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Home_slider_1, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Home_slider_1, lv_color_hex(0x7cf156), LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Home_slider_1, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Home_slider_1, 4, LV_PART_INDICATOR|LV_STATE_DEFAULT);

    //Write style for Home_slider_1, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Home_slider_1, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Home_slider_1, 3, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes Home_label_15
    ui->Home_label_15 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_15, "Temp:");
    lv_label_set_long_mode(ui->Home_label_15, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_15, 3, 195);
    lv_obj_set_size(ui->Home_label_15, 64, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_15, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_15, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_15, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_15, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_15, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_15, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_15, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_14 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_14, "3.91");
    lv_label_set_long_mode(ui->Home_label_14, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_14, 70, 168);
    lv_obj_set_size(ui->Home_label_14, 32, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_14, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_14, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_14, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_14, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_14, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_14, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_14, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_13 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_13, "M");
    lv_label_set_long_mode(ui->Home_label_13, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_13, 108, 168);
    lv_obj_set_size(ui->Home_label_13, 41, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_13, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_13, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_13, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_13, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_13, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_13, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_13, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_12 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_12, "°C");
    lv_label_set_long_mode(ui->Home_label_12, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_12, 104, 196);
    lv_obj_set_size(ui->Home_label_12, 41, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_12, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_12, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_12, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_12, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_12, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_12, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_11 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_11, "75");
    lv_label_set_long_mode(ui->Home_label_11, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_11, 69, 196);
    lv_obj_set_size(ui->Home_label_11, 32, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_11, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_11, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_11, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Home_label_11, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Home_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Home_label_11, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->Home_label_11, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_10 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_10, "%");
    lv_label_set_long_mode(ui->Home_label_10, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_10, 106, 224);
    lv_obj_set_size(ui->Home_label_10, 41, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_10, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_10, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_10, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Home_label_10, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Home_label_10, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Home_label_10, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Home_label_10, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Home_label_9 = lv_label_create(ui->Home_cont_gpu_monitor);
    lv_label_set_text(ui->Home_label_9, "90");
    lv_label_set_long_mode(ui->Home_label_9, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Home_label_9, 70, 224);
    lv_obj_set_size(ui->Home_label_9, 32, 23);
    ...
    lv_obj_set_style_radius(ui->Home_label_9, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Home_label_9, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Home_label_9, &lv_font_montserratMedium_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_line_space(ui->Home_label_9, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->Home_label_9, 1, LV_PART_MAIN|LV_STATE_DEFAULT);

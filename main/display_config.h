...
#define EXAMPLE_LCD_BUFFER_LINES       (55)
...
#define EXAMPLE_PIN_NUM_LCD_DATA0      (GPIO_NUM_45)
...
#define EXAMPLE_PIN_NUM_LCD_DATA5      (GPIO_NUM_12)
#define EXAMPLE_PIN_NUM_LCD_DATA6      (GPIO_NUM_11)
#define EXAMPLE_PIN_NUM_LCD_DATA7      (GPIO_NUM_9)
